/*
  ...
  USER:nn  (if up first)
  NAME:   Enter Name
  M.OUT:1 select on this will open "OUT:1 FROM IN:1", "OUT:1 FROM IN:2", "OUT:1 FROM IN:3" , "OUT:1 FROM IN:4", "OUT:1 FROM IN:5"->> CHANNEL LIST 1-16 on/offs
  M.OUT:2
  M.OUT:3
  M.OUT:4
  M.OUT:5
...
void dnButton() {
  ...
  if (dnHeld == 0 || dnHeld > 80) {
    ...
    if (menuLev == 2) {
      lev2Ptr++; if (lev2Ptr > 7)lev2Ptr = 0;
      menuLev2();
    }
    if (menuLev == 1) {
      lev1Ptr++; if (lev1Ptr > 7)lev1Ptr = 0;
      menuLev1();
    }
    if (menuLev == 0) {
      menuLev = 1;
...
void menuLev1() { //for up down
  ...
  switch (lev1Ptr) {
    ...
    case 4: OLEDwerds(F("M_IN:4"), 0, 0, 0); break;
    case 5: OLEDwerds(F("M_IN:5"), 0, 0, 0); break;
    case 6: OLEDwerds(F("NAME:"), 0, 0, 0); OLEDwerds(String(user + 1), 80, 0, 0); break;
    case 7: OLEDwerds(F("USER:"), 0, 0, 0); OLEDwerds(String(user + 1), 80, 0, 0); break;
  }
}
...
void menuLev2() {
  ...
  switch (lev2Ptr) {
    ...
    case 3: OLEDwerds(F("M_OUT:4"), 8, 0, 0); break;
    case 4: OLEDwerds(F("M_OUT:5"), 8, 0, 0); break;
    case 5: OLEDwerds(t, 8, 0, 0); break; // SPLIT
    case 6: OLEDwerds(F("OPTION"), 8, 0, 0); break;
    case 7: OLEDwerds(F(":EXIT:"), 16, 0, 0); break;
  }
}
  ...
  switch (lev1Ptr - 1) { //in's
    case 0:
      switch (lev2Ptr) { //out's
        ...
        case 3: chanAdj = in1out4[ch]; break;
        case 4: chanAdj = in1out5[ch]; break;
      }
      break;
    case 1:
      switch (lev2Ptr) { //out's
        ...
        case 3: chanAdj = in2out4[ch]; break;
        case 4: chanAdj = in2out5[ch]; break;
      }
      break;
    case 2:
      switch (lev2Ptr) { //out's
    ...
    case 3:
      switch (lev2Ptr) { //out's
        case 0: chanAdj = in4out1[ch]; break;
        case 1: chanAdj = in4out2[ch]; break;
        case 2: chanAdj = in4out3[ch]; break;
        case 3: chanAdj = in4out4[ch]; break;
        case 4: chanAdj = in4out5[ch]; break;
      }
      break;
    case 4:
      switch (lev2Ptr) { //out's
        case 0: chanAdj = in5out1[ch]; break;
  ...
  switch (lev1Ptr - 1) { //in's
    case 0:
      switch (lev2Ptr) { //out's
        ...
        case 3: in1out4[ch] = chanAdj; break;
        case 4: in1out5[ch] = chanAdj; break;
      }
      break;
    case 1:
      switch (lev2Ptr) { //out's
        ...
        case 3: in2out4[ch] = chanAdj; break;
        case 4: in2out5[ch] = chanAdj; break;
      }
      break;
    case 2:
      switch (lev2Ptr) { //out's
        ...
        case 3: in3out4[ch] = chanAdj; break;
        case 4: in3out5[ch] = chanAdj; break;
      }
      break;
    case 3:
      switch (lev2Ptr) { //out's
        case 0: in4out1[ch] = chanAdj; break;
        case 1: in4out2[ch] = chanAdj; break;
        case 2: in4out3[ch] = chanAdj; break;
        case 3: in4out4[ch] = chanAdj; break;
        case 4: in4out5[ch] = chanAdj; break;
      }
      break;
    case 4:
      switch (lev2Ptr) { //out's
        case 0: in5out1[ch] = chanAdj; break;
        case 1: in5out2[ch] = chanAdj; break;
        case 2: in5out3[ch] = chanAdj; break;
        case 3: in5out4[ch] = chanAdj; break;
        case 4: in5out5[ch] = chanAdj; break;
      }
      break;
  }
}
...
void clockSet() { //menuLev=6 <<<<May eveolve into auto-clock
  ...
  for (byte i = 0; i < 5; i++) {
    ...
    switch (lev1Ptr - 1) {
      ...
      case 3: k = clk4[i]; break;
      case 4: k = clk5[i]; break;
    }
...
void clockSetSel() { // toggle y/n
  ...
  if ((k & 0x01)) { // just turn off
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] &= 0xFE; break;
      case 4: clk5[i] &= 0xFE; break;
    }
    ...
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] |= 0x01; clk1[i] &= 0xFE; clk3[i] &= 0xFE; break;
      case 4: clk5[i] |= 0x01; clk2[i] &= 0xFE; clk1[i] &= 0xFE; break;
    }
...
void pcSetSel() {
  ...
  if ((k & 0x04)) { // just turn off PC for this input to that output
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] &= 0xFB; break;
      case 4: clk5[i] &= 0xFB; break;
    }
    ...
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] |= 0x04;  break;
      case 4: clk5[i] |= 0x04;  break;
    }
...
void tranSetSel() { //transpot on/off?
  ...
  if ((k & 0x02)) { // just turn off transport mess. for this input to that output
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] &= 0xFD; break;
      case 4: clk5[i] &= 0xFD; break;
    }
    ...
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] |= 0x02;  break;
      case 4: clk5[i] |= 0x02;  break;
    }
...
void ccSetSel() {
  ...
  if ((k & 0x08)) { // just turn off transport mess. for this input to that output
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] &= 0xF7; break;
      case 4: clk5[i] &= 0xF7; break;
    }
    ...
    switch (lev1Ptr - 1) {
      ...
      case 3: clk4[i] |= 0x08;  break;
      case 4: clk5[i] |= 0x08;  break;
    }
